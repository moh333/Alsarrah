...
@section('title')  لوحة التحكم | مزودى الخدمة   @endsection
@section('content')
<style>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"> مزودى الخدمة </li>
  </ol>
</nav>
    ...
    <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div  class="card-title">كل مزودى الخدمة </div>
          </div>
