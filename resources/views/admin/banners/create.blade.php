...
@section('title') لوحة التحكم | إضافة بانر إعلانى جديد @endsection
@section('content')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> إضافة بانر إعلانى جديد </li>
    </ol>
</nav>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                   <h2 class="card-title text-center">إضافة بانر إعلانى</h2>
                    {{ Form::open(array('method' => 'post','files' => true,'url' =>'admin/banner' )) }}
                        <div class="row">
