...
class FavouriteResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            'id'       => $this->id,
            'category' => $this->Company->Category['name_'.$locale],
            'name' => $this->Company['name_'.$locale],
            'image' => asset('images/'.$this->Company->image),
            'about' => $this->Company['about_'.$locale],
            ...
            'services' => explode(',',$this->Company['services_'.$locale]),
